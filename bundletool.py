...
APKTOOL_PATH = os.path.join(get_base_dir(), "tools", "apktool_2.6.0.jar")
...
BUNDLETOOL_TOOL_PATH = os.path.join(get_base_dir(), "tools", "bundletool-all-1.8.1.jar")

KEYSTORE = os.path.join(get_base_dir(), "tools", "key.jks")
